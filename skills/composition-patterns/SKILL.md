...
1. Resolve the library: `resolve-library-id` with name `React`
2. Query the specific topic: `query-docs` with libraryId `/facebook/react` and your concrete question
