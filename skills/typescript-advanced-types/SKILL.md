...
1. Resolve the library: `resolve-library-id` with name `TypeScript`
2. Query the specific topic: `query-docs` with libraryId `/microsoft/typescript` and your concrete question
