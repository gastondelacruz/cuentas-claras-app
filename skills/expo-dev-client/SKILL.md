...
1. Resolve the library: `resolve-library-id` with name `Expo Dev Client`
2. Query the specific topic: `query-docs` with libraryId `/expo/expo` and your concrete question
