...
1. Resolve the library: `resolve-library-id` with name `Expo Router`
2. Query the specific topic: `query-docs` with libraryId `/expo/router` and your concrete question
