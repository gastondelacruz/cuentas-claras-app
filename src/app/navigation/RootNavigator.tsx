...
function LoginRedirectScreen() {
  return (
    <AuthScreen
      route={{ key: 'Auth', name: 'Auth', params: { initialTab: 'login' } } as never}
      navigation={{} as never}
    />
  );
}
...
export function RootNavigator() {
  ...
  const pendingGroupInvitationToken = useAuthStore((state) => state.pendingGroupInvitationToken);
  ...
  return (
    <Stack.Navigator key={isAuthenticated ? 'authenticated' : 'guest'} initialRouteName={initialRouteName}>
      <Stack.Screen name="Onboarding" component={OnboardingScreen} options={{ headerShown: false }} />
      <Stack.Screen name="Auth" component={AuthScreen} options={{ headerShown: false }} />
      <Stack.Screen name="Main" component={GatedMainScreen} options={{ headerShown: false }} />
      <Stack.Screen name="GroupDetail" component={GatedGroupDetailScreen} options={{ headerShown: false }} />
      <Stack.Screen name="NewGroup" component={GatedNewGroupScreen} options={{ headerShown: false }} />
      <Stack.Screen name="AddExpense" component={GatedAddExpenseScreen} options={{ headerShown: false }} />
      <Stack.Screen name="AddPersonalTransaction" component={GatedAddPersonalTransactionScreen} options={{ headerShown: false }} />
      <Stack.Screen name="SettleDebts" component={GatedSettleDebtsScreen} options={{ headerShown: false }} />
